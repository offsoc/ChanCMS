...
-- ----------------------------
INSERT INTO `cms_message` VALUES (1, '1', 'ChanCMS是开源免费吗', '明空', '13366826071', 'yanyutao2014', '中国', 'ChanCMS是开源免费吗?可以商用吗？', '2025-04-02 15:47:25', '2025-12-06 22:53:46');
...
-- ----------------------------
INSERT INTO `cms_slide` VALUES (1, '01', '/public/template/default/img/01.jpg', 'https://www.chancms.top', '<h2 class=\"text-4xl font-bold mb-4\">环保科技引领未来</h2>\n<p class=\"text-xl mb-6\">专业的环保解决方案提供商</p>\n<p><a href=\"about.html\" class=\"bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-full transition duration-300\">联系我们</a></p>', NULL, NULL, 0, '2024-09-17 10:52:05', '2025-12-06 22:54:43');
INSERT INTO `cms_slide` VALUES (2, '02', '/public/template/default/img/02.jpg', 'https://www.chancms.top', NULL, NULL, NULL, 0, '2025-07-05 20:51:11', '2025-12-06 22:54:50');
...
-- Records of cms_tag
-- ----------------------------
INSERT INTO `cms_tag` VALUES (1, '图片', 'pic', 0);
INSERT INTO `cms_tag` VALUES (2, 'chancms', 'chancms', 0);
...
-- ----------------------------
INSERT INTO `ext_download` VALUES (1, 10, '文件下载', 'v2022', 'https://www.chancms.top', '1');
...
-- ----------------------------
INSERT INTO `plus_collect` VALUES (1, '人民网-top文章', 'http://www.people.com.cn/', '#rm_topline a', 1, 1, '1', 'h1', '.rm_txt_con', '1', 'http://opinion.people.com.cn/n1/2025/1021/c1003-40585875.html', '{\n \"removeSelectors\":\".paper_num\"\n}', 8, '2', '2024-08-22 16:27:19', '2025-10-21 16:57:42');
...
-- ----------------------------
INSERT INTO `plus_gather` VALUES (1, '每日新闻60s', 'https://60api.09cdn.xyz/v2/60s?encoding=json', '{\n    \"title\": {\n        \"path\": \"data.tip\"\n    },\n    \"content\": {\n        \"path\": \"data.news\",\n        \"isArray\": true,\n        \"wrap\": \"p\"\n    }\n}', 8, '2', '2023-11-29 19:10:45', '2025-10-22 13:59:38');
...
-- ----------------------------
INSERT INTO `sys_config_type` VALUES (1, 'wechat_minip', '微信小程序', '1', '微信小程序登录appId appkey', '2025-03-01 21:02:10', '2025-03-07 14:20:35');
INSERT INTO `sys_config_type` VALUES (2, 'qiniu_oss', '七牛云配置', '1', '七牛云oss配置', '2025-03-01 21:03:35', '2025-03-07 14:20:21');
INSERT INTO `sys_config_type` VALUES (3, 'cms_config', '应用设置', '1', '站点常用配置', '2025-03-04 19:10:51', '2025-03-07 14:21:05');
INSERT INTO `sys_config_type` VALUES (4, 'cms_data', '模板数据', '1', '页面模板接口配置数据', '2025-07-30 10:25:04', '2025-11-30 16:39:29');
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '登录日志' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_loginlog
-- ----------------------------
INSERT INTO `sys_loginlog` VALUES (1, 1, '122.96.14.142', '中国', '江苏', '南京', '', 'CNC Group CHINA169 Jiangsu Province Network', '32.0589', '118.7738', '2025-11-30 16:36:38');
INSERT INTO `sys_loginlog` VALUES (2, 1, '', '', '', '', '', '', '', '', '2025-12-06 22:50:34');
INSERT INTO `sys_loginlog` VALUES (3, 1, '', '', '', '', '', '', '', '', '2025-12-06 22:51:39');
INSERT INTO `sys_loginlog` VALUES (4, 1, '', '', '', '', '', '', '', '', '2025-12-06 22:51:54');
...
CREATE TABLE `sys_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 155 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '菜单权限表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (1, 0, '网站信息', 'dashboard', 0, '/dashboard', '@/views/base/dashboard/index.vue', 'DataLine', NULL, '', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (2, 0, '站点管理', '', 0, '/site', '', 'Monitor', NULL, '', 'M', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (3, 2, '站点设置', 'siteinfo', 0, '/siteinfo', '@/views/cms/site/index.vue', '', NULL, 'cms:site:info', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (4, 0, '内容管理', '', 0, '/content', '', 'Grid', NULL, '', 'M', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (5, 4, '栏目管理', 'category-index', 0, '/category', '@/views/cms/category/index.vue', '', NULL, 'cms:category:find', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (6, 5, '栏目新增', 'category-add', 0, '/category/add', '@/views/cms/category/add.vue', '', NULL, 'cms:category:create', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (7, 5, '栏目修改', 'category-edit', 0, '/category/edit/:id', '@/views/cms/category/edit.vue', '', NULL, 'cms:category:update', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (8, 5, '栏目删除', '', 0, '', '', '', NULL, 'cms:category:delete', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (9, 5, '栏目查询', '', 0, '', '', '', NULL, 'cms:category:find', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (10, 4, '文章管理', 'article-index', 0, '/article', '@/views/cms/article/index.vue', '', NULL, 'cms:article:list', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (11, 10, '文章新增', 'article-add', 0, '/article/add', '@/views/cms/article/add.vue', '', NULL, 'cms:article:create', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (12, 10, '文章修改', 'article-edit', 0, '/article/edit/:id', '@/views/cms/article/edit.vue', '', NULL, 'cms:article:update', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (13, 10, '文章删除', '', 0, '', NULL, '', NULL, 'cms:article:delete', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (14, 10, '文章详情', '', 0, '', NULL, '', NULL, 'cms:article:detail', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (15, 4, '轮播管理', 'slide-index', 0, '/slide', '@/views/cms/slide/index.vue', '', NULL, 'cms:slide:list', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (16, 15, '轮播新增', 'slide-add', 0, '/slide/add', '@/views/cms/slide/add.vue', '', NULL, 'cms:slide:create', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (17, 15, '轮播修改', 'slide-edit', 0, '/slide/edit/:id', '@/views/cms/slide/edit.vue', '', NULL, 'cms:slide:update', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (18, 15, '轮播删除', '', 0, '', NULL, '', NULL, 'cms:slide:delete', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (19, 15, '轮播详情', '', 0, '', NULL, '', NULL, 'cms:slide:detail', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (20, 4, '标签管理', 'tag-index', 0, '/tag', '@/views/cms/tag/index.vue', '', NULL, 'cms:tag:list', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (21, 20, '标签新增', 'tag-add', 0, '/tag/add', '@/views/cms/tag/add.vue', '', NULL, 'cms:tag:create', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (22, 20, '标签修改', 'tag-edit', 0, '/tag/edit/:id', '@/views/cms/tag/edit.vue', '', NULL, 'cms:tag:update', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (23, 20, '标签删除', '', 0, '', NULL, '', NULL, 'cms:tag:delete', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (24, 20, '标签详情', '', 0, '', NULL, '', NULL, 'cms:tag:detail', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (25, 4, '碎片管理', 'frag-index', 0, '/frag', '@/views/cms/frag/index.vue', '', NULL, 'cms:frag:list', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (26, 25, '碎片新增', 'frag-add', 0, '/frag/add', '@/views/cms/frag/add.vue', '', NULL, 'cms:frag:create', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (27, 25, '碎片编辑', 'frag-edit', 0, '/frag/edit/:id', '@/views/cms/frag/edit.vue', '', NULL, 'cms:frag:update', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (28, 25, '碎片删除', '', 0, '', NULL, '', NULL, 'cms:frag:delete', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (29, 25, '碎片详情', '', 0, '', NULL, '', NULL, 'cms:frag:detail', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (30, 34, '页面采集', 'collect-index', 0, '/collect', '@/views/cms/collect/index.vue', '', NULL, 'cms:collect:list', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (31, 30, '采集新增', 'collect-add', 0, '/collect/add', '@/views/cms/collect/add.vue', '', NULL, 'cms:collect:create', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (32, 30, '采集修改', 'collect-edit', 0, '/collect/:id', '@/views/cms/collect/edit.vue', '', NULL, 'cms:collect:update', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (33, 30, '采集删除', '', 0, '', NULL, '', NULL, 'cms:collect:delete', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (34, 30, '采集查询', '', 0, '', NULL, '', NULL, 'cms:collect:detail', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (35, 34, '接口采集', 'gather-index', 0, '/gather', '@/views/cms/gather/index.vue', '', NULL, 'cms:gather:list', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (36, 35, '采集新增', 'gather-add', 0, '/gather/add', '@/views/cms/gather/add.vue', '', NULL, 'cms:gather:create', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (37, 35, '采集修改', 'gather-edit', 0, '/gather/edit/:id', '@/views/cms/gather/edit.vue', '', NULL, 'cms:gather:update', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (38, 35, '采集删除', '', 0, '', NULL, '', NULL, 'cms:gather:delete', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (39, 35, '采集详情', '', 0, '', NULL, '', NULL, 'cms:gather:detail', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (40, 0, '功能管理', '', 0, '/extend', NULL, 'Operation', NULL, NULL, 'M', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (41, 40, '模型管理', 'model-index', 0, '/model', '@/views/cms/model/index.vue', '', NULL, 'cms:model:list', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (42, 41, '模型新增', 'model-add', 0, '/model/add', '@/views/cms/model/add.vue', '', NULL, 'cms:model:create', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (43, 41, '模型修改', 'model-edit', 0, '/model/edit/:id', '@/views/cms/model/edit.vue', '', NULL, 'cms:model:update', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (44, 41, '模型删除', '', 0, '', NULL, '', NULL, 'cms:model:delete', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (45, 41, '模型详情', '', 0, '', NULL, '', NULL, 'cms:model:detail', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (46, 41, '字段管理', 'field-index', 0, '/model/field', '@/views/cms/field/index.vue', '', NULL, 'cms:field:list', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (47, 46, '字段新增', 'field-add', 0, '/model/field/add', '@/views/cms/field/add.vue', '', NULL, 'cms:field:create', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (48, 46, '字段修改', 'field-edit', 0, '/model/field/edit', '@/views/cms/field/edit.vue', '', NULL, 'cms:field:update', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (49, 46, '字段删除', '', 0, '', NULL, '', NULL, 'cms:field:delete', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (50, 46, '字段详情', '', 0, '', NULL, '', NULL, 'cms:field:detail', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (51, 4, '友情链接', 'friendlink-index', 0, '/friendlink', '@/views/cms/friendlink/index.vue', '', NULL, 'cms:friendlink:list', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (52, 51, '友链新增', 'friendlink-add', 0, '/friendlink/add', '@/views/cms/friendlink/add.vue', '', NULL, 'cms:friendlink:create', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (53, 51, '友链修改', 'friendlink-edit', 0, '/friendlink/edit/:id', '@/views/cms/friendlink/edit.vue', '', NULL, 'cms:friendlink:update', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (54, 51, '友链删除', '', 0, '', NULL, '', NULL, 'cms:friendlink:delete', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (55, 51, '友链详情', '', 0, '', NULL, '', NULL, 'cms:friendlink:detail', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (56, 4, '消息管理', 'message-index', 0, '/message', '@/views/cms/message/index.vue', '', NULL, 'cms:message:list', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (57, 56, '消息新增', 'message-add', 0, '/message/add', '@/views/cms/message/add.vue', '', NULL, 'cms:message:create', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (58, 56, '消息修改', 'message-edit', 0, '/message/edit/:id', '@/views/cms/message/edit.vue', '', NULL, 'cms:message:update', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (59, 56, '消息删除', '', 0, '', NULL, '', NULL, 'cms:message:delete', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (60, 56, '消息详情', '', 0, '', NULL, '', NULL, 'cms:message:detail', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (61, 0, '系统管理', '', 0, '/sys', '', 'Setting', NULL, NULL, 'M', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (62, 61, '用户管理', 'user-index', 0, '/user', '@/views/base/user/index.vue', '', NULL, 'base:user:list', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (63, 62, '用户新增', 'user-add', 0, '/user/add', '@/views/base/user/add.vue', '', NULL, 'base:user:create', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (64, 62, '用户修改', 'user-edit', 0, '/user/edit/:id', '@/views/base/user/edit.vue', '', NULL, 'base:user:update', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (65, 62, '用户删除', '', 0, '', NULL, '', NULL, 'base:user:delete', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (66, 62, '用户详情', '', 0, '', NULL, '', NULL, 'base:user:detail', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (67, 61, '角色管理', 'role-index', 0, '/role', '@/views/base/role/index.vue', '', NULL, 'base:role:list', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (68, 67, '角色新增', 'role-add', 0, '/role/add', '@/views/base/role/add.vue', '', NULL, 'base:role:create', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (69, 67, '角色编辑', 'role-edit', 0, '/role/edit/:id', '@/views/base/role/edit.vue', '', NULL, 'base:role:update', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (70, 67, '角色删除', '', 0, '', NULL, '', NULL, 'base:role:delete', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (71, 67, '角色详情', '', 0, '', NULL, '', NULL, 'base:role:detail', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (72, 61, '菜单管理', 'menu', 0, '/menu', '@/views/base/menu/index.vue', '', NULL, 'base:menu:list', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (73, 72, '菜单新增', '', 0, '', NULL, '', NULL, 'base:menu:create', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (74, 72, '菜单修改', '', 0, '', NULL, '', NULL, 'base:menu:update', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (75, 72, '菜单删除', '', 0, '', NULL, '', NULL, 'base:menu:delete', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (76, 72, '菜单详情', '', 0, '', NULL, '', NULL, 'base:menu:detail', 'F', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (77, 61, '登录日志', 'loginlog', 0, '/loginlog', '@/views/cms/loginlog/index.vue', '', NULL, 'cms:loginLog:list', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (78, 2, '站点更新', '', 0, '', '', '', NULL, 'cms:site:update', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (79, 61, '配置字典', 'configtype', 0, '/configtype', '@/views/base/config-type/index.vue', '', NULL, 'base:config-type:list', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (80, 79, '配置列表', 'config', 0, '/configtype/:id', '@/views/base/config/index.vue', '', NULL, 'base:config:list', 'C', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (81, 79, '字典新增', '', 0, '', '', '', NULL, 'base:config-type:create', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (82, 79, '字典修改', '', 0, '', '', '', NULL, 'base:config-type:update', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (83, 79, '字典删除', '', 0, '', '', '', NULL, 'base:config-type:delete', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (84, 79, '字典查询', '', 0, '', '', '', NULL, 'base:config-type:detail', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (85, 80, '新增配置', '', 0, '', '', '', NULL, 'base:config:create', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (86, 80, '配置修改', '', 0, '', '', '', NULL, 'base:config:update', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (87, 80, '配置删除', '', 0, '', '', '', NULL, 'base:config:delete', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (88, 80, '配置查询', '', 0, '', '', '', NULL, 'base:config:list', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (89, 0, '资源管理', 'resource', 0, '/resource', '', 'Postcard', NULL, 'api:resource:all', 'M', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (90, 89, '前端模板', 'template', 0, '/template', '@/views/vip/codeEditor/index.vue', '', NULL, 'vip:v1:file:tree', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (91, 90, '模板更新', 'template-edit', 0, '', '', '', NULL, 'vip:v1:file:save', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (92, 89, '附件管理', '', 0, '/upload', '@/views/vip/data.vue', '', NULL, 'vip:v1:file:content', 'C', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (93, 72, '全部菜单', '', 0, '', NULL, '', NULL, 'base:menu:allRouter', 'I', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (94, 5, '栏目ID查找', '', 0, '', '', '', NULL, 'cms:category:findId', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (95, 5, '子栏目ID查找', '', 0, '', '', '', NULL, 'cms:category:findSubId', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (96, 5, '栏目搜索', '', 0, '', '', '', NULL, 'cms:category:search', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (97, 10, '文章列表', '', 0, '', '', '', NULL, 'cms:article:list', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (98, 10, '文章详情', '', 0, '', '', '', NULL, 'cms:article:detail', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (99, 10, '文章统计', '', 0, '', '', '', NULL, 'cms:article:tongji', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (100, 10, '查找字段', '', 0, '', '', '', NULL, 'cms:article:findField', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (101, 10, '删除文件', '', 0, '', '', '', NULL, 'cms:article:delfile', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (102, 10, '文章搜索', '', 0, '', '', '', NULL, 'cms:article:search', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (103, 10, '七牛上传Token', '', 0, '', '', '', NULL, 'cms:qiniu:getUploadToken', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (104, 10, '七牛上传', '', 0, '', '', '', NULL, 'cms:qiniu:upload', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (105, 41, '模型使用情况', '', 0, '', '', '', NULL, 'cms:model:hasUse', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (106, 46, '字段列表', '', 0, '', '', '', NULL, 'cms:field:list', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (107, 46, '字段详情', '', 0, '', '', '', NULL, 'cms:field:detail', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (108, 25, '碎片列表', '', 0, '', '', '', NULL, 'cms:frag:list', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (109, 25, '碎片详情', '', 0, '', '', '', NULL, 'cms:frag:detail', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (110, 25, '碎片搜索', '', 0, '', '', '', NULL, 'cms:frag:search', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (111, 20, '标签列表', '', 0, '', '', '', NULL, 'cms:tag:list', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (112, 20, '标签详情', '', 0, '', '', '', NULL, 'cms:tag:detail', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (113, 20, '标签检查', '', 0, '', '', '', NULL, 'cms:tag:has', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (114, 20, '标签搜索', '', 0, '', '', '', NULL, 'cms:tag:search', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (115, 51, '友情链接列表', '', 0, '', '', '', NULL, 'cms:friendlink:list', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (116, 51, '友情链接详情', '', 0, '', '', '', NULL, 'cms:friendlink:detail', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (117, 56, '留言列表', '', 0, '', '', '', NULL, 'cms:message:list', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (118, 56, '留言详情', '', 0, '', '', '', NULL, 'cms:message:detail', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (119, 56, '留言搜索', '', 0, '', '', '', NULL, 'cms:message:search', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (120, 15, '轮播列表', '', 0, '', '', '', NULL, 'cms:slide:list', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (121, 15, '轮播详情', '', 0, '', '', '', NULL, 'cms:slide:detail', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (122, 15, '轮播搜索', '', 0, '', '', '', NULL, 'cms:slide:search', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (123, 30, '获取页面', '', 0, '', '', '', NULL, 'cms:collect:getPages', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (124, 30, '获取采集文章', '', 0, '', '', '', NULL, 'cms:collect:getArticle', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (125, 30, '采集列表', '', 0, '', '', '', NULL, 'cms:collect:list', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (126, 30, '采集详情', '', 0, '', '', '', NULL, 'cms:collect:detail', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (127, 30, '采集搜索', '', 0, '', '', '', NULL, 'cms:collect:search', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (128, 35, '获取接口文章', '', 0, '', '', '', NULL, 'cms:gather:getArticle', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (129, 35, '接口采集列表', '', 0, '', '', '', NULL, 'cms:gather:list', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (130, 35, '接口采集详情', '', 0, '', '', '', NULL, 'cms:gather:detail', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (131, 35, '接口采集搜索', '', 0, '', '', '', NULL, 'cms:gather:search', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (132, 77, '创建登录日志', '', 0, '', '', '', NULL, 'cms:loginLog:create', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (133, 77, '删除登录日志', '', 0, '', '', '', NULL, 'cms:loginLog:delete', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (134, 77, '登录日志列表', '', 0, '', '', '', NULL, 'cms:loginLog:list', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (135, 62, '用户角色详情', '', 0, '', '', '', NULL, 'base:userRole:detail', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (136, 67, '角色菜单列表', '', 0, '', '', '', NULL, 'base:roleMenu:list', 'I', '2', '2', '2', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (137, 80, '配置获取列表', '', 0, '', '', '', NULL, 'base:config:getlist', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (138, 80, '配置批量更新', '', 0, '', '', '', NULL, 'base:config:updateMany', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (139, 62, '用户详情', '', 0, '', '', '', NULL, 'base:user:detail', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (140, 67, '角色列表', '', 0, '', '', '', NULL, 'base:role:list', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (141, 89, '上传Logo', '', 0, '', '', '', NULL, 'base:upload:logo', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (142, 89, '上传图片', '', 0, '', '', '', NULL, 'base:upload:img', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (143, 89, '上传多图片', '', 0, '', '', '', NULL, 'base:upload:imgs', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (144, 89, '上传文件', '', 0, '', '', '', NULL, 'base:upload:file', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (145, 89, '上传多文件', '', 0, '', '', '', NULL, 'base:upload:files', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (146, 2, '运行环境', '', 0, '', '', '', NULL, 'cms:site:runEnv', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (147, 2, '系统应用查找', '', 0, '', '', '', NULL, 'cms:sysApp:find', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (148, 2, '系统应用视图', '', 0, '', '', '', NULL, 'cms:sysApp:views', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (149, 2, '系统应用文件夹', '', 0, '', '', '', NULL, 'cms:sysApp:folder', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (150, 2, '系统应用更新', '', 0, '', '', '', NULL, 'cms:sysApp:update', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (151, 72, '菜单列表', '', 0, '', '', '', NULL, 'base:menu:list', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (152, 79, '配置类型详情', '', 0, '', '', '', NULL, 'base:config-type:detail', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (153, 80, '配置详情', '', 0, '', '', '', NULL, 'base:config:detail', 'F', '2', '2', '1', NULL, '', NULL, '', NULL, '');
INSERT INTO `sys_menu` VALUES (154, 72, '菜单列表', '', 0, '', NULL, '', NULL, 'base:menu:list', 'I', '2', '2', '2', NULL, '', NULL, '', NULL, '');
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, '超级管理员', 'super', 0, '1', '1', '', NULL, '', NULL, NULL);
INSERT INTO `sys_role` VALUES (2, '普通管理员', 'admin', 0, '1', '1', '', NULL, '', NULL, NULL);
INSERT INTO `sys_role` VALUES (3, '游客', 'visitor', 0, '1', '1', '', NULL, '', NULL, NULL);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'chancms', '', '$2b$12$dpe9JuqruCRtDhUvAyISru2uUEQ.8LEvf6HSTayn5Sipim..Pn0QG', '', '', '0', '', '', '', NULL, '', NULL, '', NULL, NULL, '1', NULL);
INSERT INTO `sys_user` VALUES (2, 'admin', '', '$2b$12$MNOt0mXmoftvWoilZODR6.Zzu2/4xHBzKDxMy5tToxHCz0mAl3zYa', '', '', '0', '', '', '', NULL, '', NULL, '', NULL, NULL, '1', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 100001 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '会员表(核心)' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (100000, 'yanyutao', NULL, '$2b$12$nNVIi36haebQlzHLTsPpduXms72RSUUTrJXBFJ3dqVyDz1VCOkVG6', '1', '867528315@qq.com', 'yanyutao2014', '13366826071', NULL, NULL, NULL, '2025-11-07 11:51:25', '2025-11-07 11:51:25', '2025-09-11 19:16:00', '2025-11-07 11:51:25', '凡有所相，皆为虚妄1234');
